        ...
        <div className="ss-cd-layout">
          <div className="ss-cd-main">
            ...
            <div className="ss-cd-meta">
              <span className="ss-cd-rating"><Stars rating={extras.rating} /> {extras.rating}</span>
              <span>({extras.reviewCount} reviews)</span>
              <span>{formatStudents(extras.students)} students</span>
              <span className="ss-cd-level">{extras.level}</span>
            </div>
            <p className="ss-cd-updated">Last updated {extras.lastUpdated} &middot; {course.totalUnits} units</p>
          ...
          <aside className="ss-cd-side">
            <div className="ss-cd-card">
              <p className="ss-cd-price">&#8377;{extras.priceINR}</p>
              {course.enrolled ? (
