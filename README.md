...
# CREATE DATABASE skillsphere\_db;
...
# | `VITE\_API\_BASE\_URL` | Base URL of the backend API |
...
# &#x20;  git clone https://github.com/nandiniverma29/TeamC\_SkillSphere-learning-nexus-fsd.git
